...
const CustomHtml = () => (
  <img src="https://img.icons8.com/ios-glyphs/30/000000/html-5.png" alt="Html" style={{
    height: "21px",
    marginBottom: "10px"
  }} />
);
...
function htmlembedHandler() {
  ...
  tooltip.save = function () {
    ...
    if (value) {
      ...
      // // this.quill.insertEmbed(range.index, 'text', value, 'user');
  ...
  tooltip.edit('html');
  tooltip.textbox.placeholder = 'Embed HTML';
}
